...
describe('CarouselSlide', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<CarouselSlide imgUrl="https://example.com/default.png" description="Default test image" />);
  });
...
describe('Img', () => {
  let mounted;
  const imgUrl = 'https://example.com/default.png';

  beforeEach(() => {
    const Img = CarouselSlide.defaultProps.Img;
    mounted = mount(<Img src={imgUrl} imgHeigh={500} />);
  });
